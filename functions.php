 ...
 */
	 ...
	 */
		include 'library/vendors/composer/zamoose/themehookalliance/tha-theme-hooks.php' ;
	 ...
	 */
		include_once get_template_directory() . '/library/vendors/composer/tgm/plugin-activation/class-tgm-plugin-activation.php' ;
