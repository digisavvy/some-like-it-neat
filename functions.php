...
function neat_recommended_required_plugins() {
	...
	$config = array(
		...
		'strings'      		=> array(
			...
			'installing'                       			=> __( 'Installing Plugin: %s', 'digistarter' ), // %1$s = plugin name
			...
			'complete' 					=> __( 'All plugins installed and activated successfully. %s', 'digistarter' ), // %1$s = dashboard link
